...
2. Make ZSH your default Terminal:
    ...
    or
        `chsh -s $(which zsh)`          # chsh stands for 'change shell'
...
7. You can change the default Theme in the "~/.zshrc":
    - `ZSH_THEME="robbyrussell"`

8. There is a lot of themes in the below folder:
    - `~/.oh-my-zsh/themes`

9. You can let the computer select one randomly for you each time you open a new terminal window:
    - `ZSH_THEME="random"`
